...
# Interpolation, Extrapolation, and the Future of Thinking
...
In a world where machines can interpolate at massive scale, the humans who thrive will be those who can do what interpolation cannot: venture past the training distribution, ask questions no one thought to ask, and recognize when the map has led them astray.
